table 50000 ar_Event
{
    ...
    fields
    {
        ...
        field(22; "All Day Event"; Boolean)
        {
            DataClassification = CustomerContent;
            ...
            var
                ...
                day: Integer;
            begin
                year := Date2DMY(DT2Date("Start Date"), 3);
                month := Date2DMY(DT2Date("Start Date"), 2);
                day := Date2DMY(DT2Date("Start Date"), 1);

                "Start Date" := CreateDateTime(DMY2Date(day, month, year), 000001T);
                "End Date" := CreateDateTime(DMY2Date(day, month, year), 235959T);
            end;
        }
    }
